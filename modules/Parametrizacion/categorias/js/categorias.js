...
function guardarDatos(losDatos) {
  $.ajax({
    type: "POST",
    url: "./modules/Parametrizacion/marcas/controllers/ctrGuardarCategorias.php",
    data: {
      losDatos: losDatos,
    },
        ...
        var columns = [
          ...
          },
          {
            ...
            render: function (data, types, full, meta) {
              ...
              <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" onchange="boton('${full.categoriaID}',this)" ${full.estadoID== 1 ? 'checked' : ''}>
              </div>`;
              return ` ${btnEliminar}`;
            },
          },
